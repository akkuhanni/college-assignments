...
namespace Demo
{
    public partial class MainForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            String imgname = @"C:\Users\Akshata\Desktop\test.png";
           // current.Save(imgname);
           // MessageBox.Show("image saved!");
            ...
            try
            {
                ...
                mail.From = new MailAddress("tempo4991@gmail.com");
                mail.To.Add("akshatawali16@gmail.com");
                mail.Subject = "Test Mail - 1";
                mail.Body = "mail with attachment";

                System.Net.Mail.Attachment attachment;
                //attachment = new System.Net.Mail.Attachment(@"C:\Users\Akshata\Desktop\wilde.png");
                attachment = new System.Net.Mail.Attachment(imgname);
                mail.Attachments.Add(attachment);

                SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("tempo4991", "P@$$word4991");
        ...
        public void Capture_image()
        {
            ...
            //when Save Current button clicked
            if (_frameSource == null)
                return;
            ...
            try
            {
                ...
                mail.To.Add("akshatawali16@gmail.com");
                mail.Subject = "Test Mail - 1";
                mail.Body = "Alert! There was an intruder in your room!";
                System.Net.Mail.Attachment attachment;
                attachment = new System.Net.Mail.Attachment(imgname);
                mail.Attachments.Add(attachment);
