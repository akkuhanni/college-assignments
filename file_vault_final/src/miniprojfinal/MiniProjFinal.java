...
public class MiniProjFinal extends javax.swing.JFrame {
            ...
            public synchronized void drop(DropTargetDropEvent evt){
                try{
                    ...
                    for(File  fe : droppedFiles){
                        ...
                        miniprojfinal.AESFileEncryption.encrypt(efilepath,"/home/akku/AndroidStudioProjects/MiniProjFinal(k)/encrypted_files");
    ...
    {
        String s1="/home/akku/AndroidStudioProjects/MiniProjFinal(k)/temp.txt";
        try
        {
           if(checkFile(s1))
        {
           BufferedReader br = new BufferedReader(new FileReader("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/imgname.txt"));     
       ...
       try {
            BufferedReader brP = new BufferedReader(new FileReader("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/passlength.txt"));     
    ...
    public void writeToLog (String fn, char type){
		...
		File lf = new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/logFile.txt");
  ...
  outputWriter.close();  
   ...
   private void LoadImage(final javax.swing.JLabel imglabel1){
       ...
       // repaint();
        ...
        icon = new ImageIcon(bi.getScaledInstance(imglabel1.getWidth(), 
         ...
         {   
            ...
            // pLength1=m;
             File lf = new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/temp.txt");
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/5b31ac14840374f58bea84ca7b503d13ff0ea412.jpg"))); // NOI18N
        Registration.add(jLabel3);
        jLabel3.setBounds(0, 0, 530, 370);
        ...
        submitOTP.setBounds(190, 188, 100, 29);
        ...
        Encrypt.setBackground(new java.awt.Color(254, 254, 254));
        ...
        encryptButton.setBounds(239, 30, 120, 29);

        dragdrop.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        dragdrop.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/plus.png"))); // NOI18N
        dragdrop.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        Encrypt.add(dragdrop);
        dragdrop.setBounds(300, 170, 220, 183);
        dragdrop.setDropTarget (new DropTarget() {
            public synchronized void drop(DropTargetDropEvent evt){
                try{
                    evt.acceptDrop(DnDConstants.ACTION_COPY);
        ...
        help.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/icon40x40help - Copy.png"))); // NOI18N
        help.setText("Help");
        ...
        Encrypt.add(help);
        help.setBounds(20, 180, 170, 50);

        activityLog.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/40px-Activity-log.svg.png"))); // NOI18N
        ...
        activityLog.setBounds(20, 240, 162, 40);

        settings.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        settings.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/picto-cb.gif"))); // NOI18N
        ...
        settings.setBounds(10, 290, 110, 40);

        resetPassword.setText("Reset Password");
        resetPassword.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        resetPassword.setBounds(20, 330, 130, 17);

        changeEID.setText("Change emailID");
        changeEID.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        changeEID.setBounds(20, 350, 130, 23);

        myFiles.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/upload-file-icon-png-28.png"))); // NOI18N
        ...
        Encrypt.add(myFiles);
        myFiles.setBounds(20, 130, 170, 50);
        ...
        decryptButton.setBounds(380, 30, 120, 29);

        jLabel2.setText("Drop your files here!");
        Encrypt.add(jLabel2);
        jLabel2.setBounds(300, 130, 150, 30);

        notifications.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/alert.png"))); // NOI18N
        ...
        notifications.setBounds(20, 70, 180, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/miniprojfinal/imaGES/1-150211232T6-50.jpg"))); // NOI18N
        Encrypt.add(jLabel1);
        jLabel1.setBounds(-11, -13, 540, 390);
    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        ...
        System.out.println("io"+pLength);
        System.out.println("kml"+pLength1);
        CardLayout card=(CardLayout)MainPanel.getLayout();
    ...
    private void ConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmActionPerformed
         for(int c=0;c<pLength1;c++)
        {
            
            System.out.println(checkP[c].x+",,"+checkP[c].y);
        } 
         for(int c=0;c<pLength;c++)
        {
            
            System.out.println(setP[c].x+","+setP[c].y);
        } 
        for(int check=0;check<=pLength-1;check++)
        {
             System.out.println(pLength1);
             System.out.println(pLength);
            if(pLength==pLength1-1)
            {
                  System.out.println("io1");//+pLength);
                  System.out.println("kml1");//+pLength1);
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
		...
		webcam.open();
                try {
					...
					ImageIO.write(webcam.getImage(), "JPG", new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/mugshots/"+name));
    ...
    private void choosePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_choosePasswordActionPerformed
        ...
        if(validateEmail(email) & validateUserName(username))
        {
             ...
             try{
                 File reg= new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/registration.txt");
                BufferedWriter outputWriter = null;
	...
	final String Spassword = "P@$$word4991";
        ...
        try{
           // BufferedReader r = new BufferedReader(new FileReader("registration.txt")).useDelimiter("\\s*,\\s*");
            BufferedReader r = new BufferedReader(new FileReader("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/registration.txt"));
    ...
    private void activityLogMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_activityLogMouseClicked
        try {
            File alf= new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/logFile.txt");
            alf.setReadOnly();
    ...
    private void myFilesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_myFilesMouseClicked
        ...
        final File dirToLock = new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/encrypted_files");
    ...
    private void notificationsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_notificationsMouseClicked
        ...
        try {
            String l1,l2;
            BufferedReader r = new BufferedReader(new FileReader("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/flagfile.txt"));
            l1=r.readLine();
            l2=r.readLine();
            if(Integer.parseInt(l1)==1) {
                JOptionPane.showMessageDialog(null,"An intruder tried to hack into the vault!" );
                File mugf= new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/mugshots/"+l2);
                mugf.setReadOnly();
            ...
            PrintWriter clr = new PrintWriter("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/flagfile.txt");
            clr.print("");
            clr.close();
            // TODO add your handling code here:
        } catch (IOException ex) {
...
// TODO add your handling code here:
    ...
    private void helpMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_helpMouseClicked
        try {
            File alf= new File("/home/akku/AndroidStudioProjects/MiniProjFinal(k)/help.txt");
            alf.setReadOnly();
            java.awt.Desktop.getDesktop().open(alf);
            // TODO add your handling code here:
        } catch (IOException ex) {
